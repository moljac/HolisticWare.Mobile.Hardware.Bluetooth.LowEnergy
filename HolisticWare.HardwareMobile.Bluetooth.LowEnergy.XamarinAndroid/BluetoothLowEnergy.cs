...
[assembly: Android.App.UsesPermission(Android.Manifest.Permission.Bluetooth)]
[assembly: Android.App.UsesPermission(Android.Manifest.Permission.BluetoothAdmin)]

[assembly: Android.App.UsesFeature(name: "android.hardware.bluetooth_le", Required=true)]
...
//		}
		...
		{
			protected BluetoothLowEnergy _parent;

			public GattCallback (BluetoothLowEnergy parent)
			{
				this._parent = parent;
			}
